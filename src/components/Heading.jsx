										...
										<div className="relative pt-6 px-4 sm:px-6 lg:px-8">
											<nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
												...
												<div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
													...
													<a href="#" className="font-medium text-tkhpurple hover:text-indigo-500">
														Testimonials
													</a>
												</div>
											</nav>
										...
										>
											<Popover.Panel focus static className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
												<div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
													...
													<a
														href="#"
														className="block w-full px-5 py-3 text-center font-medium text-tkhpurple bg-gray-50 hover:bg-gray-100"
													>
														Log in
													</a>
												</div>
							...
							<main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
								<div className="sm:text-center lg:text-left">
									<h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
										...
										<span className="block text-tkhpurple xl:inline">succeed</span>
									</h1>
									<p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
										“I believe that anyone with the motivation to learn and continuously self-improve has the opportunity for a spectacular
										career and life via means that weren't possible for previous generations.”
									</p>
									...
									<div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
										<div className="rounded-md shadow">
											<a
												href="#"
												className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-tkhpurple hover:bg-indigo-700 md:py-4 md:text-lg md:px-10"
											>
												Get started
											</a>
										</div>
